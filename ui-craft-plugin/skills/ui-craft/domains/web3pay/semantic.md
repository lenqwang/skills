...
> Web3Pay 域语义 Token。继承 `primitive.md` 的中性色和状态色，
> 品牌色覆盖见 `domain.md`。
...
- Web3/Pay: --brand: #ADF73E (绿色) → 见 [web3pay/domain.md](../domains/web3pay/domain.md)
...
> 以下 Token 仅适用于 Pay B端商户后台场景，继承上方 Platform Token，覆盖品牌色等。
> 来源: Figma [Pay-B端-商家后台](https://www.figma.com/design/tlFIl7F7A7Zl6e9WRLMDZo/) · [V5.1-Web-H5组件库](https://www.figma.com/design/kQIx9xKLiyO6KZIbazNSM2/)

### GTPay 专属 Design Tokens
...
GTPay 品牌色 `#ADF73E` 与 Web3/Pay App 品牌色 `#17E5A1` 不同。Pay B端商户后台的品牌强调色为 `#68AD00`（Green-500），替换了 Platform 层 Brand/6 蓝色系。

| 语义 | Platform 值 | Pay-B 覆盖值 | 说明 |
|------|------------|-------------|------|
| 品牌色 | Brand/6（蓝色） | `#ADF73E`（亮绿） | Pay 品牌主色 |
| 品牌强调色 | Brand/6 | `#68AD00`（绿色） | 按钮/CTA/文本 |
| 主按钮 | Brand/6 | `#68AD00` | Primary Button 背景 |
| 主按钮 Hover | Brand/7 | `#489200` | Primary Button Hover |
| 主按钮 Active | Brand/7 | `#548D00` | Primary Button Active |
| 品牌文本 | Brand/6 | `#68AD00` | 品牌强调文字绿色 |
| 品牌图标 | Brand/6 | `#68AD00` | 品牌强调图标绿色 |

### 色彩语义映射

#### 文字色（Text Colors）

| Token | Light 模式 | CSS 变量 | 用途 |
|-------|-----------|---------|------|
| `text-primary` | `#070808` | `--color-text-primary` | 主标题、正文 |
| `text-secondary` | `#84888C` | `--color-text-secondary` | 次要文字、表头 |
| `text-tertiary` | `#A0A3A7` | `--color-text-tertiary` | 三级辅助文字、Placeholder |
| `text-disable` | `#C4C7CA` | `--color-text-disable` | 禁用态文字 |
| `text-brand` | `#68AD00` | `--color-text-brand` | 品牌强调文字（绿色） |
| `text-inverse-primary` | `#FFFFFF` | `--color-text-inverse` | 反色文字（深色/绿色背景上） |
| `text-always-black` | `#070808` | `--color-text-always-black` | 固定黑色 |
| `text-always-white` | `#FFFFFF` | `--color-text-always-white` | 固定白色 |
| `text-error` | `#EF4444` | — | 错误文字 |
| `text-warning` | `#FF6600` | — | 警告文字 |
| `text-success` | `#68AD00` | — | 成功文字（= 品牌强调色） |

#### 背景色（Background Colors）

| Token | Light 模式 | CSS 变量 | 用途 |
|-------|-----------|---------|------|
| `bg-primary` | `#FFFFFF` | `--color-bg-primary` | 默认页面背景（亮色模式） |
| `bg-secondary` | `#FAFBFC` | `--color-bg-secondary` | 侧边栏背景、表头背景 |
| `bg-tertiary` | `#F2F3F4` | `--color-bg-tertiary` | 三级容器/筛选栏背景 |
| `bg-quaternary` | `#F5F6F7` | `--color-bg-quaternary` | 柔和按钮背景、输入框背景 |
| `bg-card` | `#FAFAFA` | `--color-bg-card` | 卡片背景 |
| `bg-always-white` | `#FFFFFF` | `--color-bg-always-white` | 固定白色 |
| `bg-mask` | `rgba(0,0,0,0.5)` | `--color-bg-mask` | 弹窗遮罩 |

#### 图标色（Icon Colors）

| Token | 色值 | CSS 变量 | 用途 |
|-------|------|---------|------|
| `icon-primary` | `#303236` | `--color-icon-primary` | 主要图标 |
| `icon-secondary` | `#5A5E66` | `--color-icon-secondary` | 次要图标 |
| `icon-tertiary` | `#84888C` | `--color-icon-tertiary` | 三级图标 |
| `icon-quaternary` | `#A0A3A7` | `--color-icon-quaternary` | 四级图标 |
| `icon-brand` | `#68AD00` | `--color-icon-brand` | 品牌强调图标（绿色） |
| `icon-disable` | `#C4C7CA` | — | 禁用图标 |

#### 边框线条（Border Colors）

| Token | 色值 | CSS 变量 | 用途 |
|-------|------|---------|------|
| `border-subtle` | `#F2F3F4` | `--color-border-subtle` | 浅色描边 |
| `border-strong` | `#DFE0E2` | `--color-border-strong` | 卡片/面板边框 |
| `divider` | `#F2F3F4` | `--color-divider` | 行分割线 |
| `short-divider` | `#C4C7CA` | `--color-divider-short` | 文字间竖线/短分割线 |
| `gutter` | `#DFE0E2` | `--color-gutter` | 模块间分隔 |

#### 组件色（Component Colors）

| Token | 色值 | CSS 变量 | 用途 |
|-------|------|---------|------|
| `button-primary` | `#68AD00` | `--color-button-primary` | 主按钮背景（品牌强调绿） |
| `button-primary-hover` | `#489200` | `--color-button-primary-hover` | 主按钮悬停 |
| `button-primary-active` | `#548D00` | `--color-button-primary-active` | 主按钮按下 |
| `button-soft` | `#F5F6F7` | `--color-button-soft` | 次要/柔和按钮背景 |
| `button-soft-active` | `#DFE0E2` | `--color-button-soft-active` | 柔和按钮激活 |
| `button-soft-disable` | `#F5F6F7` | `--color-button-soft-disable` | 柔和按钮禁用 |
| `component-active` | `#303236` | `--color-component-active` | 选中态描边（输入框聚焦等） |
| `input-bg` | `#FAFAFA` | — | 输入框背景 |

#### 链接色（Link Colors）

| Token | 色值 | CSS 变量 | 用途 |
|-------|------|---------|------|
| `link-default` | `#0068FF` | `--color-link` | 默认链接 |
| `link-pressed` | `#004FD9` | `--color-link-pressed` | 链接按下态 |
...
> Pay B端使用自定义交易色：买入绿 `#68AD00`，卖出橙 `#FF6600`

| Token | Light | Dark | 用途 |
|-------|-------|------|------|
| `Trade-Buy` | `#68AD00` | `#68AD00` | 交易买入色（绿），按钮/文字 |
| `Trade-Sell` | `#FF6600` | `#FF6600` | 交易卖出色（橙），按钮/文字 |
| `Trade-Buy-Soft` | `#E6F4D2` | GreenTrade/10 | 买入背景色 |
| `Trade-Sell-Soft` | `#FFF3E0` | RedTrade/10 | 卖出背景色 |
| `Trade-Buy-Active` | `#548D00` | `#548D00` | 买入按钮激活色 |
| `Trade-Sell-Active` | `#D95500` | `#D95500` | 卖出按钮激活色 |

#### 状态色/特殊色（Status Colors）

| Token | Light | Dark | 用途 |
|-------|-------|------|------|
| `Success` | `#68AD00` | `#68AD00` | 成功色（主色） |
| `Success-Active` | GreenFunct/7 | GreenFunct/5 | 成功激活色 |
| `Success-Disabled` | GreenFunct/3 | GreenFunct/8 | 成功禁用色 |
| `Success-Soft` | `#E6F4D2` | GreenFunct/10 | 成功背景色 |
| `Hot` | `#F7594B` | `#F7594B` | 火图标颜色（热门标识） |
| `Star` | Yellow/6 | Yellow/6 | 星星图标颜色 |
| `VIP-Bg` | VIPFunct/1 | VIPFunct/7 | VIP 属性标签背景色 |
| `VIP-Text` | Neutral/12 | VIPFunct/5 | VIP 属性标签文字色 |
| `Reward-Text` | Promotion/Pumpkin | Promotion/Pumpkin | 增长业务福利文字色 |
...
| `Chart-3` | GreenTrade/5 | 绿色涨跌 |
| `Chart-4` | GreenTrade/3 | 绿色涨跌背景 |
| `Chart-5` | `#68AD00`（Pay B端品牌强调色） | 品牌强调色，单维度图表主体色 |
| `Chart-6` | Promotion/Blue | 辅助对比色，多维度图表 |
| `Chart-7` | Neutral/12（L）/ Neutral/White（D） | 强对比色 |
| `Chart-8` | Neutral/3（L）/ Neutral/8（D） | 最低层级图例色 |
| `Chart-9` | Yellow/6 | 黄色图表色，视情况选用 |
...
:root {
  /* === 品牌绿色阶 === */
  --gtpay-green-950: #1A3300;
  --gtpay-green-900: #264D00;
  --gtpay-green-800: #377100;
  --gtpay-green-700: #489200;
  --gtpay-green-600: #548D00;
  --gtpay-green-500: #68AD00;
  --gtpay-green-400: #82C41F;
  --gtpay-green-300: #9FD64D;
  --gtpay-green-200: #B8E580;
  --gtpay-green-100: #D4E5C7;
  --gtpay-green-50:  #E6F4D2;

  /* === GTPay 专属 === */
  --gtpay-brand: #ADF73E;            /* 品牌色 */
  --gtpay-brand-accent: #68AD00;     /* 品牌强调色 */
  --gtpay-component-hover: #E6F4D2;

  /* === 背景 === */
  --color-bg-primary: #FFFFFF;
  --color-bg-secondary: #FAFBFC;
  --color-bg-tertiary: #F2F3F4;
  --color-bg-quaternary: #F5F6F7;
  ...
  --color-text-tertiary: #A0A3A7;
  --color-text-disable: #C4C7CA;
  --color-text-brand: #68AD00;           /* 品牌强调色 */
  --color-text-inverse: #FFFFFF;
  --color-text-always-black: #070808;
  --color-text-always-white: #FFFFFF;

  /* === 图标 === */
  --color-icon-primary: #303236;
  --color-icon-secondary: #5A5E66;
  --color-icon-tertiary: #84888C;
  --color-icon-quaternary: #A0A3A7;
  --color-icon-brand: #68AD00;           /* 品牌强调色 */

  /* === 边框/线条 === */
  --color-border-subtle: #F2F3F4;
  --color-border-strong: #DFE0E2;
  --color-divider: #F2F3F4;
  --color-divider-short: #C4C7CA;
  --color-gutter: #DFE0E2;

  /* === 组件 === */
  --color-button-primary: #68AD00;
  --color-button-primary-hover: #489200;
  --color-button-primary-active: #548D00;
  --color-button-soft: #F5F6F7;
  --color-button-soft-active: #DFE0E2;
  --color-button-soft-disable: #F5F6F7;
  --color-component-active: #303236;

  /* === 功能 === */
  --color-trade-buy: #68AD00;
  --color-trade-buy-active: #548D00;
  --color-trade-sell: #FF6600;
  --color-trade-sell-active: #D95500;
  --color-error: #EF4444;
  --color-warning: #FF6600;
  --color-success: #68AD00;
  --color-hot: #F7594B;
...
> 字体家族：**GateProductSans**（商户后台主字体）/ **Switzer**（Figma V5 设计系统备选）

#### 字体家族

```css
$font-family-base: "GateProductSans", "Switzer", -apple-system,
...
| 字重值 | 名称 | 用途 |
|--------|------|------|
| 400 | Regular | 正文、描述、Placeholder |
| 500 | Medium | 按钮文字、菜单项、数据行 |
| 600 | Semibold | 标题、强调文本、卡片标题、表头 |
| 700 | Bold | 大标题（仅 H5 端 H8/H9） |
...
| Token | 字重 | 字号 | 后台典型用途 |
|-------|------|------|------------|
| H1 | 600 Semibold | 48px | — |
| H2 | 600 Semibold | 40px | — |
| H3 | 600 Semibold | 32px | 页面大标题 |
| H4 | 600 Semibold | 28px | 页面标题 |
| H5 | 600 Semibold | 24px | 分组标题 |

**Subtitle（模块标题）**

| Token | 字重 | 字号 | 后台典型用途 |
|-------|------|------|------------|
| S3 | 600 Semibold | 20px | 卡片标题 |
| S4 | 500 Medium | 20px | 卡片副标题 |
| S5 | 600 Semibold | 18px | 分组标题 |
| S6 | 500 Medium | 18px | 分组副标题 |
| S7 | 600 Semibold | 16px | 小节标题 |

**Body（正文）**

| Token | 字重 | 字号 | 后台典型用途 |
|-------|------|------|------------|
| B3 | 500 Medium | 16px | 强调正文 |
| B5 | 400 Regular | 16px | 标准正文 |
| B6 | 600 Semibold | 14px | 表头、标签、强调 |
| B7 | 500 Medium | 14px | 按钮文字、菜单项 |
| B8 | 400 Regular | 14px | 表格数据、描述 |
| B9 | 600 Semibold | 12px | 小标签（加粗） |
| B11 | 500 Medium | 12px | 辅助文字、状态徽章 |
| B13 | 400 Regular | 12px | 最小辅助文字 |

**BodyMulti（多行段落）**

| Token | 字重 | 字号 | 行高 |
|-------|------|------|------|
| BM1 | 400 Regular | 16px | 150% |
| BM2 | 400 Regular | 14px | 150% |
| BM3 | 400 Regular | 12px | 150% |

#### 行高规范

| 类型 | 行高 |
|------|------|
| Display / Heading / Subtitle / Body（单行） | 1.3（130%） |
| BodyMulti（多行段落） | 1.5（150%） |
...
> 来自 Figma 页面内 `字阶` 框架（Node: `42528:13083`）

**Display**

| 变体 | 字号 | 字重 | Letter Spacing |
|------|------|------|----------------|
| d1_regular | 88pt | Regular | 0 |
| d1_bold | 88pt | Semibold | 0 |
| d2_regular | 64pt | Regular | 0 |
| d2_bold | 64pt | Semibold | 0 |
| d3 | 40pt | Regular / Semibold | 0 |
| d4 | 32pt | Regular / Semibold | 0 |

**Heading**

| 变体 | 字号 | 字重 | Letter Spacing |
|------|------|------|----------------|
| h1 | 32pt | Regular / Semibold | 0 |
| h2 | 28pt | Regular / Semibold | 0 |
| h3 | 24pt | Regular / Semibold | 0 |
| h3-1 | 20pt | Regular / Semibold | 0 |
| h4 | 18pt | Regular / Semibold | 0 |

**Subtitle**

| 变体 | 字号 | 字重 | Letter Spacing |
|------|------|------|----------------|
| s1 | 20pt | Regular / Semibold | 0 |
| s2 | 18pt | Regular / Semibold | 0 |
| s3 | 16pt | Regular / Semibold | 0 |
| s4 | 14pt | Regular / Semibold | 0 |
| s5 | 12pt | Regular / Semibold | 0 |

**BodySingle（单行正文，Bold = Medium）**

| 变体 | 字号 | 字重 | Letter Spacing |
|------|------|------|----------------|
| bs1 | 16pt | Regular / Medium | 0 |
| bs1-1 | 15pt | Regular / Medium | 0 |
| bs2 | 14pt | Regular / Medium | 0 |
| bs3 | 12pt | Regular / Medium | 0 |

**BodyMultiple（多行段落，行高 150%，Bold = Medium）**

| 变体 | 字号 | 字重 | Line Height |
|------|------|------|-------------|
| bm0 | 20pt | Regular / Medium | 150% |
| bm0-1 | 18pt | Regular / Medium | 150% |
| bm1 | 16pt | Regular / Medium | 150% |
| bm1-1 | 15pt | Regular / Medium | 150% |
| bm2 | 14pt | Regular / Medium | 150% |
| bm3 | 12pt | Regular / Medium | 150% |

**Caption（说明描述）**

| 变体 | 字号 | 字重 | Letter Spacing |
|------|------|------|----------------|
| c1 | 12pt | Regular / Medium | 0 |
| c2 | 11pt | Regular / Medium | 0 |
| c3 | 10pt | Regular / Medium | 0 |

#### 后台字体层级速查

```
页面大标题   → H3 / H4  → 32px / 28px / Semibold 600
分组标题     → S5 / S7  → 18px / 16px / Semibold 600
卡片标题     → S3       → 20px / Semibold 600
正文强调     → B7       → 14px / Medium 500
正文常规     → B8       → 14px / Regular 400
表头         → B6       → 14px / Semibold 600（或 B11 12px Medium）
辅助/徽章    → B11      → 12px / Medium 500
```

### 间距系统补充

> 以下为 Pay B端商户后台特有的间距定义，补充 Platform 层间距体系。
...
| space-3 | 12px | 中小间距（按钮组） |
| space-4 | 16px | 标准间距（段落、列表项） |
| space-5 | 20px | 中间距 |
| space-6 | 24px | 大间距（Gutter、卡片间） |
| space-8 | 32px | 较大间距（页面内边距） |
| space-10 | 40px | 区块间距 |
| space-12 | 48px | 模块间距 |
| space-16 | 64px | 模块间距（H5 较大） |
| space-45 | 180px | 页面级大段落间距 |
...
| 组件 | 间距 | Token 映射 |
|------|------|-----------|
| 按钮内边距（LG-44px） | 0 24px | `space-6` (左右) |
| 按钮内边距（MD-40px） | 0 20px | `space-5` (左右) |
| 卡片内边距 | 24px | `space-6` (四周) |
| 输入框内边距 | 10px 14px | — (专属值) |
| 表格列间距 | 0 16px | `space-4` (左右) |
| 弹窗内边距 | 32px | `space-8` (四周) |
| Tag 内边距 | 4px 12px | `space-1` / `space-3` |
...
| 按钮组（水平） | 12px | `space-3` |
| 按钮组（垂直） | 16px | `space-4` |
| 卡片间距 | 20-24px | `space-5` ~ `space-6` |
| 表单字段间距 | 24px | `space-6` |
| 导航项间距 | 24px | `space-6` |
| 面包屑分隔间距 | 8px | `space-2` |
| 图标与文字间距 | 8px | `space-2` |
| 筛选标签组间距 | 8px | `space-2` |
| 表格行操作列间距 | 12px | `space-3` |
| Toast 堆叠间距 | 8px | `space-2` |

### 阴影/Z-index/圆角补充

#### 阴影 Shadow Token（Light / Dark 双主题）

| Token | 层级 | CSS 值（Light 模式参考） | 适用场景 |
|-------|------|----------------------|---------|
| Shadow01 | 低 | `0 2px 4px rgba(0,0,0,0.08)` | 卡片、按钮 |
| Shadow02 | 中 | `0 4px 8px rgba(0,0,0,0.12)` | 悬浮卡片、下拉菜单 |
| Shadow03 | 高 | `0 8px 16px rgba(0,0,0,0.15)` | 弹窗、浮层 |
| Shadow04 | 极高 | `0 12px 24px rgba(0,0,0,0.18)` | 模态框 |
| Shadow-inner | 内阴影 | `inset 0 2px 4px rgba(0,0,0,0.06)` | 输入框聚焦 |
| Shadow/dropdown | 特殊 | — | 下拉列表专用阴影 |
...
|------|-------------|------|------|
| 背景层 | 0 | 页面主体内容 | 默认文档流 |
| 悬浮卡片 | 10 | 吸顶表头、悬浮操作栏 | 轻量浮起 |
| 下拉面板 | 100 | Dropdown、Select 面板、Tooltip | 输入型浮层 |
| 固定导航 | 200 | Header、Sidebar | 全局导航始终可见 |
| 抽屉 | 300 | Drawer 侧滑抽屉 | 覆盖内容区但不覆盖弹窗 |
| 遮罩层 | 400 | Modal Overlay | 半透明黑色遮罩 `rgba(0,0,0,0.4)` |
| 弹窗 | 500 | Modal / Dialog | 模态弹窗内容 |
| Toast | 600 | Toast 通知 | 最顶层，始终可见 |
| 系统级 | 9999 | 全屏 Loading、错误蒙层 | 极端场景兜底 |
...
| `none` | 0px | 无圆角 |
| `xsmall` | 2px | 标签（Tag） |
| `small` | 4px | 小按钮、快筛、二级菜单 |
| `default` | 6px | 默认（输入框、一级菜单、Dropdown） |
| `medium` | 8px | 弹窗、卡片、表格容器 |
| `large` | 12px | 大卡片、面板 |
| `xlarge` | 16px | Popup header |
| `full` | 999px | 按钮、开关、头像、徽标 |

### 颜色语义映射速查

```
品牌色       → Brand (#ADF73E)            Pay 品牌主色（亮绿）
品牌强调色   → Brand Accent (#68AD00)      品牌强调绿（按钮/CTA/文本）
主要操作     → Primary-Green (#68AD00)     品牌强调绿主按钮
主按钮悬停   → Green-700 (#489200)
主按钮按下   → Green-600 (#548D00)
次要操作     → Secondary-Gray (#F5F6F7)
买入/看涨    → Green (#68AD00)            与品牌强调色同色系
卖出/看跌    → Orange (#FF6600)
链接/信息    → Blue (#0068FF)
错误/危险    → Red (#EF4444)
禁用状态     → Disable (#C4C7CA)
品牌文本     → Brand Accent (#68AD00)      品牌强调文本绿
导航激活     → Green-50 (#E6F4D2)          侧边栏选中态（与组件 Hover 同色）
组件 Hover   → Green-50 (#E6F4D2)
成功徽章     → Green-50 (#E6F4D2) bg + Green-500 text
```
